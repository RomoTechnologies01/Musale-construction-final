...
import { Box, Container, Grid, Typography, Link, inputAdornmentClasses } from "@mui/material";
...
export default function Home() {
  ...
  return (
    <div style={{paddingTop:'80px', overflowX:"hidden"}}>
      ...
      <Box className="paper">
        <Box sx={{ marginTop: '0', fontSize: '18px', fontWeight: 600, color: 'gray' }}>
          NEWS |
        </Box>
      ...
      <Box sx={{ marginTop: 4 }}>
        ...
        <Grid container spacing={4}>
          ...
          <div style={{display:"flex", flexDirection:"row", margin:"0 2px",padding:"20px" , height:"400px",background:"url(" + "https://patelinfra.com/images/homepage/section_bg.jpg" + ")", backgroundPosition: 'center',
            backgroundSize: 'cover',  backgroundRepeat: 'no-repeat'}}>
          <div style={{margin:"20px 20px 0 10px", width:"450px",height:"50px", padding:"20px 0 0 10px", gap:"0" }}>
            <h2 style={{ textAlign: 'start', color:"#BFBFBF", fontFamily: 'gilroyextrabold', fontSize:"65px", fontWeight:"bold", letterSpacing: 0.03}}>OUR</h2>
            <h2 style={{ textAlign: 'start', color:"#BFBFBF", fontFamily: 'gilroyextrabold', fontSize:"65px", fontWeight:"bold", letterSpacing: 0.03}}>PHILOSOPHY.</h2>
          </div>
          <div style={{padding:"20px 30px", margin:"20px 2px 20px 60px", width:"550px", color:"#fff", lineHeight:"1.5"}}>
                <ul>
                  <li>To bring in a high level of execution skills, meet customer benchmarks serve customers and : through timely completion of projects without compromising on quality.</li>
                  <li>To improve on existing quality-system in its operations.</li>
                  <li>To achieve greater productivity and safety standards.</li>
                  <li>To develop human resources and improve employee attitudes.</li>
                  <li>To maintain good growth of net worth and build on the assets of the company.</li>
                  <li>To be a market leader and a highly dependable services provider.</li>
                  <li> To develop partnerships for growth and diversification.</li>
                </ul>
            </div>
        </div>

      <div style={{display:"flex", flexDirection:"row", margin:"20px 2px", height:"250px"}}>
          <div style={{margin:"20px 10px 0 10px", width:"450px",height:"250px", padding:"10px 20px 0 0", gap:"0" }}>
            <h2 style={{ textAlign: 'start', color:"#BFBFBF", fontFamily: 'gilroyextrabold', fontSize:"65px", fontWeight:"bold", letterSpacing: 0.03}}>VISION & </h2><br></br>
            <h2 style={{ textAlign: 'start', color:"#BFBFBF", fontFamily: 'gilroyextrabold', fontSize:"65px", fontWeight:"bold", letterSpacing: 0.03}}>MISSION</h2>
          </div>
          <div style={{padding:"10px 50px", margin:"20px 50px", width:"600px"}}>
            ...
            <ul>
              ...
              <li>We shall ensure quality, reliability and continuous technology up gradation thereby enhancing the value of all our stakeholders.</li>
            </ul>
            </div>
        </div>
      <div style={{display:"flex", flexDirection:"row", margin:"0 2px", height:"250px"}}>
          <div style={{margin:"30px 10px 0 10px", width:"450px",height:"250px", padding:"10px 20px 0 0", gap:"0" }}>
            <h2 style={{ textAlign: 'start', color:"#BFBFBF", fontFamily: 'gilroyextrabold', fontSize:"65px", fontWeight:"bold", letterSpacing: 0.03}}>VALUES</h2><br></br>
          </div>
          <div style={{padding:"20px 40px", margin:"20px 50px", width:"600px"}}>
              <ul>
